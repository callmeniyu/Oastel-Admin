...
export default function StatusToggle({
  ...
  // Sync internal status with prop changes - the key fix for the status toggle issue
  useEffect(() => {
    // This ensures the component updates when initialStatus changes from parent
  ...
  const handleToggle = async () => {
    ...
    try {
      ...
      // Let the parent update the initialStatus which will flow back via the effect above
      // This ensures that the UI will reflect the actual state from the API
    } catch (error) {
