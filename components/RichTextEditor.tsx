...
import { FiBold, FiItalic, FiUnderline, FiList, FiLink, FiType } from "react-icons/fi"
...
export default function RichTextEditor({
    ...
    if (!editor) {
        return (
            <div className={`h-32 bg-gray-100 rounded animate-pulse flex items-center justify-center ${className}`}>
