          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-1">
              ...
              <div className="mt-6 top-8">
                ...
                <div className="flex w-full flex-col gap-2 items-center md:hidden space-x-4">
                  <button
                    type="button"
                    onClick={() => setShowClearConfirmation(true)}
                    className="w-full text-center px-4 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition-colors duration-200 flex items-center space-x-2"
                  >
                    <FiX size={16} />
                    <span>Clear Form</span>
                  </button>
                  <button
                    type="button"
                    onClick={handleShowErrors}
                    className="w-full text-center px-4 py-2 bg-green-100/50 text-primary rounded-lg transition-colors duration-200 flex items-center space-x-2"
                  >
                    <FiCheck size={16} />
                    <span>Validate</span>
                  </button>
